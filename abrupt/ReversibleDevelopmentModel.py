...
if __name__ == '__main__':
    ...
    #mainPath = '/media/nicole/Elements/Results_reversible_development_model/5_ts/'
            ...
            for argumentP in argumentPArr:
                ...
                if standardPlots:
                    for startEnv in startEnvList:
                        ...
                        policyPlotReduced_v2Paper(int(T) + 1,0.7, priorE0Arr, cueValidityC0E0Arr,
                        ...
                        # plotArgs = ["MaturePhenotypes"]  #"RankOrderStability" "FitnessDifference", "MaturePhenotypes",
